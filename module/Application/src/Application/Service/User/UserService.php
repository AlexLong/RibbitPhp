...
use Application\Service\Interfaces\User\UserServiceInterface;
...
class UserService implements ServiceLocatorAwareInterface, UserServiceInterface{
    ...
    {
        return $this->getServiceLocator()->get('RepositoryAccessor')->get('user_profile');
    }
    ...
    {
        return  $this->getServiceLocator()->get('RepositoryAccessor')->get('users');
    }
